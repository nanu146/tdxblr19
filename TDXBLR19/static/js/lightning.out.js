...
if (!window.$Lightning) {
  $Lightning = (function() {
    ...
    function getDelegateScriptUrl() {
      ...
      var url =
        "/lightning/lightning.out.delegate.js?v=" + getDelegateScriptVersion();
    ...
    return {
      ...
      createComponent: function() {
        return $Lightning._delegate.createComponent.apply(
          this,
          Array.prototype.slice.call(arguments)
        );
      },
      getApplication: function() {
        return $Lightning._delegate.getApplication.apply(
          this,
          Array.prototype.slice.call(arguments)
        );
      },
      lightningLoaded: function() {
        return $Lightning._delegate.lightningLoaded.apply(
          this,
          Array.prototype.slice.call(arguments)
        );
      },
      ready: function() {
        return $Lightning._delegate.ready.apply(
          this,
          Array.prototype.slice.call(arguments)
        );
      }
